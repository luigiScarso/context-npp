...
This macro is discussed towards the end of \in{Section}[autocompletion]. It provides a method of \emph{word completion} for control sequences, to complement primary \emph{function completion}.
\stophead
